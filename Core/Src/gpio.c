...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : INLET_RED_Pin AMS_OK_Pin ISOSPI_CS_Pin ISOSPI_EN_Pin
  ...
  /*Configure GPIO pins : SENSE_SDC_HVIL_Pin SENSE_SDC_BTB_Pin SENSE_SDC_MOTOR_Pin IMD_OK_IN_Pin */
  ...
  /*Configure GPIO pins : TRIGGER_CURRENT_Pin PRECHARGE_OUT_Pin */
  ...
  /*Configure GPIO pins : OVC_SENSE_Pin PRECHARGE_IN_Pin */
  ...
  /*Configure GPIO pins : CRASH_Pin HW_WAKE_Pin BUTTON2_Pin BUTTON1_Pin */
  GPIO_InitStruct.Pin = CRASH_Pin|HW_WAKE_Pin|BUTTON2_Pin|BUTTON1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : IMD_OK_OUT_Pin HEATER2_Pin HEATER1_Pin */
  ...
  /*Configure GPIO pins : PB0 PB1 PB10 PB11
                           PB12 PB13 PB15 PB4
                           PB5 PB6 I2C_SCL_Pin I2C_SDA_Pin */
  ...
  /*Configure GPIO pins : HV_N_Pin HV_P_Pin HV_M_Pin HV_Charger_Pin
                           AKKU_LED_Pin POTI_RS_Pin POTI_SHDN_Pin RECUPERATION_Pin
                           AMS_LIMIT_Pin */
